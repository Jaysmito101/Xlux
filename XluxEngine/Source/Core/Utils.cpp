...
XLUX_API F32 GetTime() {
  ...
  return (F32)(now.tv_sec - startTime.tv_sec) +
         (F32)(now.tv_nsec - startTime.tv_nsec) / 1000000000.0f;

#endif
}

XLUX_API Bool IsPointInTriangle(const math::Vec2& p, const math::Vec2& a,
                                const math::Vec2& b, const math::Vec2& c) {
  // Compute vectors
  math::Vec2 v0 = c - a;
  math::Vec2 v1 = b - a;
  math::Vec2 v2 = p - a;
