...
class Window {
 public:
  inline static void Create(const xlux::String& title, xlux::I32 width,
                            xlux::I32 height) {
    if (!s_Instance) s_Instance = new Window(title, width, height);
  }
  ...
  static void SetPixel(xlux::F32 x, xlux::F32 y, xlux::F32 r, xlux::F32 g,
  ...
  inline static void SetHeight(xlux::I32 height) {
    s_Instance->m_Height = height;
  }
  inline static xlux::RawPtr<WindowFramebuffer> GetFramebuffer() {
    return s_Instance->m_Framebuffer;
  }

#ifdef XLUX_USE_IMGUI
  inline static void InitializeImGui() {
    s_Instance->m_ImGuiInitialized = true;
  }
  inline static bool IsImGuiInialized() {
    return s_Instance->m_ImGuiInitialized;
  }
#endif
...
class WindowFramebuffer : public xlux::IFramebuffer {
 public:
  ...
  virtual void SetColorPixel(xlux::I32 channel, xlux::I32 x, xlux::I32 y,
                             xlux::F32 r, xlux::F32 g, xlux::F32 b,
                             xlux::F32 a) override;
  virtual void SetDepthPixel(xlux::I32 x, xlux::I32 y,
                             xlux::F32 depth) override;

  virtual void GetColorPixel(xlux::I32 channel, xlux::I32 x, xlux::I32 y,
                             xlux::F32& r, xlux::F32& g, xlux::F32& b,
                             xlux::F32& a) const override;
  virtual void GetDepthPixel(xlux::I32 x, xlux::I32 y,
                             xlux::F32& depth) const override;
};