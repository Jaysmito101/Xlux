...
IMGUI_IMPL_API void ImGui_ImplXlux_RenderDrawData(
...
IMGUI_IMPL_API bool ImGui_ImplXlux_RecreateVtxIdxBuffers(
    xlux::Size vertex_buffer_size, xlux::Size index_buffer_size);
