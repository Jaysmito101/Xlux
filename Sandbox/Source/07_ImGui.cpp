...
int main() {
  ...
  const auto vertices = std::vector<VertexInData>{
      ...
      VertexInData(xlux::math::Vec3(0.0f, 0.5f, 0.0f),
                   xlux::math::Vec3(0.0f, 0.0f, 1.0f))};

  const auto indices = std::vector<xlux::U32>{0, 1, 2};
  ...
  while (!Window::HasClosed()) {
    ...
    Window::SetTitle(
        "Xlux Engine [Hello Triangle] - Jaysmito Mukherjee - FPS: " +
...
void LoadStyle() {
  ...
  colors[ImGuiCol_TabActive] =
      ImVec4(51.0f / 255, 31.0f / 255, 49.0f / 255, 0.97f);
  colors[ImGuiCol_TabUnfocused] =
      ImVec4(51.0f / 255, 31.0f / 255, 49.0f / 255, 0.57f);
  ...
  colors[ImGuiCol_TabUnfocused] =
      ImVec4(43.0f / 255, 17.0f / 255, 43.0f / 255, 0.97f);
